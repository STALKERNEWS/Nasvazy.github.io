<?php
$act = $_REQUEST['act'];
/* $Id: video.php 142 2009-03-26 09:15:25Z szerrade $ */
if($act == ""){
$page = "video";
include "header.php";
...
if($act == "a_choose_video_box"){

$page = "a_choose_video_box";
include "header.php";
...
// GET VIDEO COMMENTS
$comment = new se_comment('video', 'video_id', $video->video_info['video_id']);
$total_comments = $comment->comment_total();
