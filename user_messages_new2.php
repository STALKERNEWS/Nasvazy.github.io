...
if($task=="validate" || $task=="send") {
  ...
  if(count($tos) > 5) {
    ...
    foreach($tos AS $to_username) {
      $validate_where .= ( $validate_where=="" ? "WHERE " : " OR " );
      $validate_where .= "se_users.user_username='$to_username'";
    }
...
// CRANK SMILES START // 
$asconf['smiles'] = "baffled,biggrin,confused,cool,dull,eek,growl,nerd,no,oo,redface,rofl,rolleyes,sad,sorry,tongue,wink,yes,smile,frown,mad"; 
$i = 0; 
